...
(function dartProgram() {
  ...
  F = {
    ...
    asetaVastausvaihtoehdot: function(vaihtoehdot) {
      ...
      for (t1 = J.getInterceptor$asx(vaihtoehdot), i = 0; i < H._asNum(t1.get$length(vaihtoehdot)); ++i)
  ...
  F.main_closure.prototype = {
    call$1: function(e) {
      ...
      t4 = document.querySelector("#kysymys");
      if (t4 != null)
        J.set$text$x(t4, H._asStringQ(t3));
  ...
  F.lisaaVastausvaihtoehto_closure.prototype = {
    call$1: function(e) {
      ...
      type$.MouseEvent._as(e);
      t1 = this.elementti;
      if (H._asBool(J.$index$asx(this.vaihtoehto, "oikein")))
